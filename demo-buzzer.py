...
def playMario():
  mario = ( (E6, .000 ),     (C6, .111 ),  (rest, .001 ),     (E6, .000 ), 
         ...
         (rest, .001 ),    (AS5, .119 ),  (rest, .001 ),     (A5, .119 ), 
         ...
         (rest, .001 ),     (B5, .239 ),  (rest, .001 ),    (AS5, .119 ), 
         ...
         (rest, .121 ),     (G6, .119 ),  (rest, .001 ),    (FS6, .119 ), 
         (rest, .001 ),     (F6, .119 ),  (rest, .001 ),    (DS6, .119 ), 
         (rest, .121 ),     (E6, .000 ),     (C6, .119 ),  (rest, .121 ), 
           (GS5, .119 ),  (rest, .001 ),     (A5, .119 ),  (rest, .001 ), 
            (C6, .119 ),  (rest, .121 ),     (A5, .119 ),  (rest, .001 ), 
            (C6, .119 ),  (rest, .001 ),     (D6, .119 ),  (rest, .001 ), 
            (C5, .119 ),  (rest, .121 ),     (G6, .119 ),  (rest, .001 ), 
           (FS6, .119 ),  (rest, .001 ),     (F6, .119 ),  (rest, .001 ), 
           (DS6, .119 ),  (rest, .121 ),     (E6, .000 ),     (C6, .119 ), 
         (rest, .121 ),     (C7, .000 ),     (E6, .119 ),  (rest, .121 ), 
           ...
           (FS6, .119 ),  (rest, .001 ),     (F6, .119 ),  (rest, .001 ), 
           (DS6, .119 ),  (rest, .121 ),     (E6, .000 ),     (C6, .119 ), 
         (rest, .121 ),    (GS5, .119 ),  (rest, .001 ),     (A5, .119 ), 
         (rest, .001 ),     (C6, .119 ),  (rest, .121 ),     (A5, .119 ), 
         (rest, .001 ),     (C6, .119 ),  (rest, .001 ),     (D6, .119 ), 
         (rest, .241 ),    (DS6, .000 ),    (GS5, .119 ),  (rest, .241 ), 
         ...
         (rest, .001 ),    (FS6, .119 ),  (rest, .001 ),     (F6, .119 ), 
         (rest, .001 ),    (DS6, .119 ),  (rest, .121 ),     (E6, .000 ), 
         ...
         (rest, .001 ),    (FS6, .119 ),  (rest, .001 ),     (F6, .119 ), 
         (rest, .001 ),    (DS6, .119 ),  (rest, .121 ),     (E6, .000 ), 
            (C6, .119 ),  (rest, .121 ),    (GS5, .119 ),  (rest, .001 ), 
            (A5, .119 ),  (rest, .001 ),     (C6, .119 ),  (rest, .121 ), 
            (A5, .119 ),  (rest, .001 ),     (C6, .119 ),  (rest, .001 ), 
            (D6, .119 ),  (rest, .241 ),    (DS6, .000 ),    (GS5, .119 ), 
         ...
         (rest, .121 ),     (G5, .239 ),  (rest, .121 ),    (GS5, .239 ), 
         ...
         (rest, .001 ),     (A6, .000 ),     (F6, .159 ),  (rest, .001 ), 
           ...
           (GS5, .239 ),  (rest, .001 ),     (A5, .119 ),  (rest, .001 ), 
         ...
         (rest, .121 ),    (GS5, .239 ),  (rest, .001 ),     (A5, .119 ), 
         ...
         (rest, .001 ),     (G6, .000 ),     (B5, .159 ),  (rest, .001 ), 
            ...
            (G5, .119 ),  (rest, .121 ),     (C5, .119 ),  (rest, .121 ), 
            (E6, .119 ),  (rest, .001 ),     (C6, .119 ),  (rest, .121 ), 
            (G5, .239 ),  (rest, .121 ),    (GS5, .239 ),  (rest, .001 ), 
