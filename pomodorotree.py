        ...
        if state == "MODE_SETTINGS":
            with canvas(device) as draw:
                ...
                if mode == "POMODORO":
                    ...
                    draw.text((25, 10), "00:25:00", font=fontBig, fill="white") #TODO Timing conversion printing
                if mode == "TASK":
                ...
                if mode == "BUDGET":
                    ...
                    draw.text((25, 15), "00:55:00", font=fontBig, fill="white") # TODO Budget break timing
        ...
        if state == "MODE_SETTINGS_2":
            with canvas(device) as draw:
                ...
                if mode == "POMODORO":
                    draw.text((31,45), "P | Settings", font=fontSmall, fill="white")  # Removed cycles
                    draw.text((25, 0), "Set Break Time:", font=fontSmall, fill="white")
                    draw.text((25, 10), "00:05:00", font=fontBig, fill="white") #TODO Timing conversion printing
